        ...
        <div class="d-flex justify-content-between w-100">
          ...
          <div>
            <?php if($_settings->userdata('id') > 0 && $_settings->userdata('login_type') ==3): ?>
              ...
              <!-- <span class="mx-2">Howdy, <?= !empty($_settings->userdata('username')) ? $_settings->userdata('username') : $_settings->userdata('email') ?>
              ...
              <div class="dropdown">
                ...
                <span class="mx-2"><img src="">  <span class="mx-2">Welcome, <?= !empty($_settings->userdata('username')) ? $_settings->userdata('username') : $_settings->userdata('email') ?></span>
                </a>
            ...
            <?php else: ?>
              ...
              <a href="./seller" class="mx-2 text-light text-decoration-none font-weight-bolder">Seller Login</a> | 
