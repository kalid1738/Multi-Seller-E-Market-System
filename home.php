...
<div class="col-lg-12 py-5">
    <div class="contain-fluid">
        ...
        <div class="row" id="product_list">
            <?php 
            $products = $conn->query("SELECT p.*, v.shop_name as vendor, c.name as `category` FROM `product_list` p inner join seller_list v on p.seller_id = v.id inner join category_list c on p.category_id = c.id where p.delete_flag = 0 and p.`status` =1 order by RAND() limit 4");
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 product-item">
                ...
                <div class="product-img-holder position-relative">
                    <img src="<?= validate_image($row['image_path']) ?>" alt="Product" class="img-top product-img bg-gradient-gray">
                </div>
