        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    $vtotal = $conn->query("SELECT sum(c.quantity * p.price) FROM `cart_list` c inner join product_list p on c.product_id = p.id where c.client_id = '{$_settings->userdata('id')}' and p.seller_id = '{$vrow['id']}'")->fetch_array()[0];   
